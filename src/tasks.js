//# 8. JavaScript. Задачи по массивам
...
const answer1 = data.map(item => ({ id: item.id, username: item.username }));
console.log(answer1);

const answer2 = data.map(item => item.email);
console.log(answer2);

const answer3 = data.find(item => item.id ===9);
console.log(answer3);

const answer4 = data.filter(item => item.address.city === 'Lebsackbury');
console.log(answer4);

const answer5 = data.slice(0,4);
console.log(answer5);
...
const answer8 = data.filter(item => item.website.includes('.com'));
console.log(answer8);

const answer9 = data.filter(item => item.username.length > 12);
console.log(answer9);

const answer10 = data.map(item => item.username.toLowerCase());
